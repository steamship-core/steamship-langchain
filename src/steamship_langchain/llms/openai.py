...
import json
import logging
from typing import Any, List, Mapping, Optional, Dict, Generator
...
class OpenAI(BaseOpenAI):
    ...
    # model_kwargs, openai_api_key, batch_size, request_timeout, max_retries
    ...
    def _default_params(self) -> Dict[str, Any]:
        ...
        normal_params = {
            ...
            "max_words": self.max_tokens,  # TODO: Change naming
            "top_p": self.top_p,
            "frequency_penalty": self.frequency_penalty,
            "presence_penalty": self.presence_penalty,
            "n_completions": self.n,
            "best_of": self.best_of,
            # "request_timeout": self.request_timeout, # TODO: Support this in gpt-3
            # "logit_bias": self.logit_bias, # TODO: Support this in gpt-3
        }

        return {**normal_params, **self.model_kwargs} # TODO: Check support for model_kwargs
    ...
    def raise_on_unsupported_arguments(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        if unsupported_arguments := set(values.keys()).intersection({"request_timeout","logit_bias"}):
    ...
    def _instance_handle(self, stop: Optional[List[str]] = None) -> str:
        ...
        return f'gpt-{hashlib.sha256(json.dumps(params, sort_keys=True).encode("utf-8")).hexdigest()}'
    ...
    def _generate(self, prompts: List[str], stop: Optional[List[str]] = None) -> LLMResult:
        ...
        return LLMResult(generations=generations,
                         llm_output=None)  # TODO: Add support for logging token_usage
            ...
            for text_block in generation_file.blocks:
                for block_tag in text_block.tags:
                    if block_tag.kind == TagKind.GENERATION:
                        # TODO: Add generation_info
                        generations.append(Generation(text=block_tag.value[TagValueKey.STRING_VALUE]))
